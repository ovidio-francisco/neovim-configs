...
--[[ todo: deixar o keybind do ; dinâmico.
   [     inicialmente é comentar;
   [     quando precionar f, muda para o original; E seta temporariamente hjkl para o movimento + mapear ; para comentar.
   [     quando precionar hjkl volta para comentar; ]]
